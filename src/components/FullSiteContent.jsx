            ...
            <section className="section-container">
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={sectionVariants}>
                    ...
                    <div className="triple-grid-large mt-12">
                        ...
                        <div className="glass-card step-card"><span className="step-num">03</span><h4>Start Adding Inventory</h4><p>Start adding inventory to your Vizion POS and take the first step towards a more organized and profitable business. Our System is designed to simplify and enhance your stock management.</p><button className="btn-primary mt-6">Shop Now</button></div>
                    </div>
                </motion.div>
            </section>
                ...
                <div className="section-container">
                    <div className="footer-grid-main mb-20 flex flex-col md:flex-row justify-between gap-16">
                        ...
                        <div className="footer-nav md:ml-auto md:pl-24">
                            ...
                            <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-4 text-lg">
                                <li><a href="#loyalty" className="text-white hover:text-yellow-500 transition-colors">Loyalty Program</a></li>
                                <li><a href="#ordering" className="text-white hover:text-yellow-500 transition-colors">Online Ordering</a></li>
                                <li><a href="#bulk" className="text-white hover:text-yellow-500 transition-colors">Bulk Pricing</a></li>
                                <li><a href="#employees" className="text-white hover:text-yellow-500 transition-colors">Employees</a></li>
                                <li><a href="#payments" className="text-white hover:text-yellow-500 transition-colors">Payments</a></li>
                                <li><a href="#analytics" className="text-white hover:text-yellow-500 transition-colors">Analytics</a></li>
                            </ul>
                        </div>
                    </div>
